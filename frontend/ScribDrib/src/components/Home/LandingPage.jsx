    ...
    <div className="landing-page">
      ...
      <nav className="navbar">
        <div className="navbar-container">
          <Link to="/" className="navbar-logo">
            ...
            <span className="logo-text">ScribDrib</span>
          </Link>
      ...
      <section id="benefits" className="benefits-section">
        ...
        <div className="benefits-container">
          <div className="benefits-left">
            <h2>Why Teams Choose ScribDrib</h2>
      ...
      <section id="team" className="team-section">
        ...
        <div className="team-container">
          <h2>Creative Minds Behind ScribDrib</h2>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-bottom">
            <p>© 2026 ScribDrib. Built with <span className="heart">❤</span> by Aman Mishra, Ayush Pratap Singh & Suraj Kumar Gupta.</p>
          </div>
        </div>
      </footer>
    </div>
